...
In other words, a CTMC leads to an evolution of the marginal distribution $q_t\in\Delta{(\mathcal X)}$ that follows the Kolmogorov ODE $dq_t/dt = q_t Q_t$.
