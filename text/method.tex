...
In \alg{}, both $w$ and $\pi$ are parameterized by neural networks $w_\phi$ and $\pi_\phi$ sharing weights $\phi$; see Appendix~\ref{subsec:architecture}. Substituting the parameterization into \eqref{eq:vlp} gives the loss function used for training \alg{}:
\begin{align*}
...
We defer the detailed description of the model architecture and training/inference algorithms used in \alg{} to Appendix~\ref{sec:further-vlp}. 