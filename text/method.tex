...
We defer the detailed description of the model architecture and training/inference algorithms used in VLP to Appendix~\ref{sec:further-vlp}. In \alg{}, both $w$ and $\pi$ are parameterized by neural networks $w_\phi$ and $\pi_\phi$ sharing weights $\phi$; see Section~\ref{subsec:architecture}. Substituting the parameterization into \eqref{eq:vlp}, the loss function we use for training VLP is
\begin{align*}
