...
In \alg{}, both $w$ and $\pi$ are parameterized by neural networks $w_\phi$ and $\pi_\phi$ sharing weights $\phi$. Substituting the parameterization into \eqref{eq:vlp}, the loss function we use for training VLP is
\begin{align*}
