...
In words, $\pi^*$ will deterministically output the index set $\mathcal U^*$ with the smallest total entropy (highest confidence) as the next unmasking step. The proof is deferred to Appendix~\ref{subsec:proof-confidence}.
