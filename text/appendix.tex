...
\begin{table*}[t]
\centering
\caption{Effect of KL regularization strength $\lambda$ in policy training for RADD. We report perplexity ($\downarrow$) and entropy of unconditional generation at different sampling steps.}
\setlength{\tabcolsep}{4.5pt}
...
\midrule
0
& \textbf{311.1} & 187.2 & 144.2 & 130.6
& 5.79 & 5.72 & 5.68 & 5.68 \\
$10^{-3}$
& 314.2 & 183.7 & 146.3 & 123.7
& 5.79 & 5.74 & 5.69 & 5.66 \\
$10^{-2}$
& 313.2 & 182.0 & 143.6 & 122.9
& 5.78 & 5.73 & 5.69 & 5.65 \\
$10^{-1}$
& 318.4 & \textbf{180.8} & \textbf{136.2} & \textbf{112.2}
& 5.77 & 5.71 & 5.66 & 5.64 \\
\bottomrule
\end{tabular}
\label{tab:text-kl}
