...
\begin{wrapfigure}{r}{0.45\textwidth}
    ...
    \caption{Two different sampling trajectories of decoding a length-2 sequence on a simple vocabulary $\{\texttt{A},\texttt{B}\}$. Confidence-based unmasking indicates that trajectory 1 is preferred. \jiaxin{Let's tweak the example such that the two tokens are not independent? Otherwise the order is not relevant}}
