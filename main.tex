...
While this work focuses on masked diffusion, our likelihood framework naturally extends to other discrete or continuous diffusion formulations. Future work may pursue improvements in optimization and training efficiency for likelihood-based policies, and explore the possibility of joint training with MDMs.
