...
\newcommand{\jiaxin}[1]{\textcolor{orange}{[Jiaxin: #1]}}
\newcommand{\strblk}[1]{\sethlcolor{black!12}\hl{\texttt{\footnotesize #1}}}

\title{Understanding and Generalizing Confidence-Based Decoding in Masked Diffusion Models}
...
Research Fellowship. Sijin Chen acknowledges support from Princeton University's Gordon Wu Fellowship. The work reported on in this paper was substantially performed using Princeton University’s Research Computing resources. 
